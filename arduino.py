...
pins = [('L/R (9)<br>', 9), ('F/B (10)<br>', 10), ('Twist (11)<br>', 11), ('Slider (3)<br>', 3),('Button<br>L/R (5)', 5), ('Button<br>F/B (6)', 6)]
axis_map = {0: 9, 1: 10, 2: 11, 3: 3, 4: 5, 5: 6}
...
def reader_thread(fh, queue):
    ...
    while True:
        ...
        if char == '\n' or char == '\r':
            ...
            msg = chars.tostring()
            if string.find(msg, "\xDE\xAD\xBE\xEF") == -1:
                print "got %s" % msg
            else:
...
def get_pin_num(name):
    try:
        ...
        return False
def set_pin(pin, value): outqueue.put("%d %d\n" % (value, pin))
